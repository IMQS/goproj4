...
func TestCs2Cs(t *testing.T) {
	...
	*/
	...
	temp := []*globals.XYZ{&globals.XYZ{128410.08539230417, 445806.50796043128, 100}}
	cs2cs.Transform(temp)

	out := []*globals.XYZ{&globals.XYZ{52.00000000963378, 5.000000001518494, 143.61519583221525}}
